...
file_directory = 'C:\\IPSTERS\\sraster\\ins3\\sampling_1'
...
#write.csv(stat_metrics,"S1_stat_metrics_1000s_ndvi.csv")
#write.csv(overall_accuracy ,"S1_overall_accuracy_1000s_ndvi.csv")
```
