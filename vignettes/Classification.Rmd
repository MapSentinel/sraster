...
df3 = data.frame(rep(names_result,rep(30,13)),result, Base = c('Base_3_d'))


#write.csv(result_stat,"stat_sampling3_5000s_total.csv")
#write.csv(df3,"stat_sampling3_5000s_ggplot.csv")
```
