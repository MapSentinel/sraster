...
file_directory = 'C:\\IPSTERS\\sraster\\ins4\\sampling_1'
...
#write.csv(stat_metrics,"S3_stat_metrics_7000s_ndvi_BD.csv")
#write.csv(overall_accuracy ,"S3_overall_accuracy_7000s_ndvi_DB.csv")
```
