...
file_directory = 'C:\\IPSTERS\\sraster\\ins3\\sampling_4'
...
#write.csv(stat_metrics,"S3_stat_metrics_7000s_ndvi.csv")
#write.csv(overall_accuracy ,"S3_overall_accuracy_7000s_ndvi.csv")
```
