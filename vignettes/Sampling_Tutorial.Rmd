...
```{r }
shape = legend_class_q1[legend_class_q1$OBJECTI == 50419,]  #8557
shape_buffer = legend_class_buffer_q1[legend_class_buffer_q1$OBJECTI == 50419,]
...
file_index = 'C:\\IPSTERS\\sraster\\ins4\\sampling_0\\output_urban_norule.csv'
