...
```{r }
shape = legend_class_q1[legend_class_q1$OBJECTI == 8727 ,]  #8557
shape_buffer = legend_class_buffer_q1[legend_class_buffer_q1$OBJECTI == 8727,]
...
file_index = 'C:\\IPSTERS\\sraster\\ins4\\sampling_0\\output_baresoil_norule.csv'
