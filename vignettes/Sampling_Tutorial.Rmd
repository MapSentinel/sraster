...
lim_max = quantile(areas_poly,probs=c(0.45))
...
```{r }
shape = legend_class_q1[3,]  #16596
shape_buffer = legend_class_buffer_q1[3,]
...
#legend_class_buffer_q2 = legend_class_buffer_q2[!(legend_class_buffer_q2$OBJECTI %in% #c(91652,91678,91658,91659,91660)),]
